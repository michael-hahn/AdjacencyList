  ...
  def main(args: Array[String]): Unit = {
    try {
      ...
      */
      ...
      val lines = lc.textFile("/Users/Michael/IdeaProjects/InvertedIndex/myLog", 1)
      ...
      //println("PrintOut of contentRdd")
      //        contentRdd.collect().foreach(println)

//      contentRdd.collect().foreach(s => {
//        pw.append(s.toString)
//        pw.append('\n')
//      })
...
/*
      if (exhaustive == 1) {
        ...
        delta_debug.ddgen(contentRdd, listRdd, new Test, new Split, lm, fh)
      }
